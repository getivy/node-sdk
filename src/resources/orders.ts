...
export class Orders extends APIResource {
  ...
  /**
   * Expire an order. This will set the order to status `canceled` immediately. All
   * transactions which arrive afterwards for this order will be returned
   * automatically.
   */
...
export interface OrderCreateResponse {
   ...
   */
  shippingMethod?: OrderCreateResponse.ShippingMethod;
...
export interface OrderExpireResponse {
   ...
   * express Checkout Session or passed during Checkout Session creation.
   */
  shippingMethod?: OrderExpireResponse.ShippingMethod;
