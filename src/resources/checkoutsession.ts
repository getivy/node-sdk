...
export class Checkoutsession extends APIResource {
   ...
   * information.
   */
  create(body: CheckoutsessionCreateParams, options?: RequestOptions): APIPromise<CheckoutsessionCreateResponse> {
   ...
   */
  retrieve(body: CheckoutsessionRetrieveParams, options?: RequestOptions): APIPromise<CheckoutsessionRetrieveResponse> {
   ...
   */
  expire(body: CheckoutsessionExpireParams, options?: RequestOptions): APIPromise<CheckoutsessionExpireResponse> {
...
export namespace CheckoutsessionCreateParams {
  ...
  export interface SettlementDestination {
    ...
    /**
     * Physical address of the bank that holds the settlement account. Must match the
     * address of the financial institution associated with the provided account
     * details.
     */
    bankAddress?: SettlementDestination.BankAddress;
